 ...
 * Page as category
*/
function spark_panels_page_as_category($post_id) {
...
add_action('save_post_page', 'spark_panels_page_as_category');

function spark_panels_refresh_page_hierarchy($post_id) {
...
add_action('before_delete_post', 'spark_panels_refresh_page_hierarchy');

function spark_panels_delete_page_as_category($post_id) {
...
add_action('deleted_post', 'spark_panels_delete_page_as_category');
