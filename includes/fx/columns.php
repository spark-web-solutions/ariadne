<?php
if (!function_exists('spark_array_to_columns')) {
	/**
	 ...
	 */
	function spark_array_to_columns(array $list, $cols) {
	    $listlen = count($list);
...
if (!function_exists('spark_sort_array_for_columns')) {
	/**
	 ...
	 */
	function spark_sort_array_for_columns(array $list, $cols) {
	    $partition = spark_array_to_columns($list, $cols);
	    $sorted_list = array();
